class Clock {
    ...
    playAlarm() {
        ...
        document.body.style.background = 'url("img/Gojo-Satoru-5PCS-Stickers-for-Water-Bottles-Laptop-Cartoon-Room-Window-Art-Cute-Stickers-Anime-Car (1).jpg")';
    }

    turnOffAlarm(alarmAudio) {
        alarmAudio.muted = true; 
        document.querySelector(this.alarmDiv + " button").style.display = "none";
        document.body.style.background = 'url("img/Galaxy-Wallpaper-High-Resolution-1.jpg")';
    }
